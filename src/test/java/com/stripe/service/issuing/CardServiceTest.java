...
public class CardServiceTest extends BaseServiceTest {
  ...
  public void testDetails() throws StripeException {
    CardDetails details = this.client.issuing().cards().details("ic_123");
    assertNotNull(details);
    assertEquals("issuing.card_details", details.getObject());
    this.verifyRequest(ApiResource.RequestMethod.GET, "/v1/issuing/cards/ic_123/details");
  }

  @Test
  public void testCreate() throws StripeException {
    CardCreateParams params =
        CardCreateParams.builder().setCurrency("usd").setType(Type.PHYSICAL).build();
