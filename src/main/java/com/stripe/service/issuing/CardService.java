...
public class CardService extends Service<Card> {
   ...
   * card.
   *
   * @param id the id of the card for which to retrieve the details
   * @return the details of the card
   * @throws StripeException if the request fails
   */
  public CardDetails details(String id) throws StripeException {
    return this.details(id, null, null);
  }
  ...
  public CardDetails details(String id, CardDetailsParams params) throws StripeException {
    return this.details(id, params, null);
  }
  ...
  public CardDetails details(String id, CardDetailsParams params, RequestOptions options)
    ...
    return this.request(
        ...
        String.format("/v1/issuing/cards/%s/details", StringUtils.urlEncode(id)),
        params,
        options);
  }
